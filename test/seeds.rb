...
class User < ActiveRecord::Base
  ...
  has_many :posts
  has_many :posts_with_comments, ->{ joins(:post_comments).distinct }, class_name: 'Post'
  has_many :posts_and_comments , ->{ left_joins(:post_comments).distinct }, class_name: 'Post'
end
